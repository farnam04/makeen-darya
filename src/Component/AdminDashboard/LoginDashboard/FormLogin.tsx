  ...
  return (
    <div className="flex flex-col items-center w-full h-full  ">
      <div className="flex flex-col items-center w-[600px] h-full ">
        ...
        <div className="w-full h-[53px] flex items-center flex-row-reverse justify-end mt-[112px] ">
          <p className="text-[16px] text-[#404040] ">
            به پنل مدیریت سفری به قله خوش آمدید
          </p>
        </div>
        <div className="h-[300px] w-full flex flex-col items-center mt-[100px] ">
          <input
            type="text"
          ...
          />
          <button className="w-full h-[48px] bg-[#194BF0] rounded-[10px] mt-[100px] text-center text-white ">
            ورود به پنل
          </button>
        </div>
      </div>
